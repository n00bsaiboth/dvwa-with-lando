...
$_DVWA = array();
$_DVWA[ 'db_server' ]   = getenv('DB_SERVER') ?: 'database';
$_DVWA[ 'db_database' ] = getenv('DB_DATABASE') ?: 'lamp';
$_DVWA[ 'db_user' ]     = getenv('DB_USER') ?: 'lamp';
$_DVWA[ 'db_password' ] = getenv('DB_PASSWORD') ?: 'lamp';
